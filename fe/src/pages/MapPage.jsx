...
const mapToPercentage = (x, y) => {
  const mappedX = ((x - mapBounds.xMin) / (mapBounds.xMax - mapBounds.xMin)) * 100;
  const mappedY = ((y - mapBounds.yMin) / (mapBounds.yMax - mapBounds.yMin)) * 100;
...
const MapPage = () => {
  ...
  return (
    ...
    <div style={{ fontFamily: "Arial", padding: "1rem" }}>
      ...
      {/* 현재 좌표 출력 */}
      <p>
        현재 위치: <strong>X:</strong> {position.x.toFixed(2)}, <strong>Y:</strong> {position.y.toFixed(2)}
      </p>
