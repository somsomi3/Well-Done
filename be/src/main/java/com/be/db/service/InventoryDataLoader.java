...
public class InventoryDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Object[][] displaySpots = {
                ...
                {"A2", "빼빼로", -47.89, -63.69, 180},

                {"B1", "카스타드", -51.16, -63.69, 180},
                {"B2", "카스타드", -51.67, -63.69, 180},

                {"C1", "오뜨", -48.73, -63.07, 90},
                {"C2", "오뜨", -48.70, -62.58, 90},

                {"D1", "쿠크다스", -50.45, -63.11, -90},
                {"D2", "쿠크다스", -50.45, -62.56, -90},

                {"E1", "화이트하임", -47.38, -61.98, 0},
                {"E2", "화이트하임", -47.89, -61.98, 0},

                {"F1", "뽀또", -51.17, -62.01, 0},
                {"F2", "뽀또", -51.69, -61.93, 0},

                {"G1", "마가렛트", -47.40, -60.27, 180},
                {"G2", "마가렛트", -47.90, -60.25, 180},

                {"H1", "빠다코코낫", -51.20, -60.17, 180},
                {"H2", "빠다코코낫", -51.70, -60.19, 180},

                {"I1", "몽쉘", -48.75, -59.40, 90},
                {"I2", "몽쉘", -48.73, -58.92, 90},

                {"J1", "오예스", -50.45, -59.41, -90},
                {"J2", "오예스", -50.45, -58.90, -90},

                {"K1", "에이스", -47.39, -58.01, 0},
                {"K2", "에이스", -47.90, -58.01, 0},
